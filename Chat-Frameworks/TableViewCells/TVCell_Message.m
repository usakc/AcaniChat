...
- (void) setMessage:(Message* )message rightward: (BOOL) rightward
{
    ...
    CGSize size = 
    [text sizeWithFont:
     [UIFont systemFontOfSize:kMessageFontSize]
    ...
    if (rightward) { // right bubble
        ...
        msgText.frame = CGRectMake(self.contentView.frame.size.width-size.width-22.0f-editWidth,
        ...
        msgBackground.frame = 
        CGRectMake(0.0f, kMessageFontSize-13.0f,
